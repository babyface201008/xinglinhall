layui.config({
	...
	$.get(PUBLIC_URL+"json/newsList.json",
		function(data){
			var waitNews = [];
	...
	//图片总数
	$.get(PUBLIC_URL+"json/images.json",
		function(data){
	...
	//用户数
	$.get(PUBLIC_URL+"json/usersList.json",
		function(data){
	...
	//新消息
	$.get(PUBLIC_URL+"json/message.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : PUBLIC_URL+"json/systemParameter.json",
			type : "get",
			dataType : "json",

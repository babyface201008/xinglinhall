...
class AdminGroup extends Base{
    ...
    */
    public  function save(){
        ...
        if($postData['op'] == 'add'){//添加
            ...
            //查询用户信息
            $groupData = admingroupModel::get($postData['groupid']);
    ...
    */
    public  function getAdminGroupEditJSON(){
        ...
        $this->_data(array('admingroupData'=>$groupData));
    }
    ...
    */
    public  function getMenuListJSON()
    {
        ...
        //获取菜单
        $menuData = $this->adminmenuModel->getList('isshow=1');
        //排序
        $menuData = $this->array2sort($menuData,'parentid');
        //树状结构
        $menuData = $this->treeToArray2($menuData,'menuid','parentid');
        ...
        $this->assign($data);
        return $this->fetch('admin_group/menu_list');
    }

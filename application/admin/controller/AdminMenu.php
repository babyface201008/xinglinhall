...
class AdminMenu extends Base{
    ...
    public function edit(){
        ...
        return $this->fetch('admin_menu/edit',array('data'=>$menuData));
    }
    /*
    * 删除信息
    */
...
//        编辑数据
    ...
    */
    public function getMenuTreeJSON(){
        ...
        $type = input('get.type');
        $condition = '1=1';
        $list = $this->adminMenuModel->getList($condition,'menuid,parentid,menuname,icon');
        $treeList = array();
        if($list){
        ...
        if($type==1)array_unshift($treeList,array('id'=>0,'pid'=>0,'text'=>'顶级分类'));
